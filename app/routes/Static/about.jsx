...
class FAQ extends React.Component {
	render() {
        ...
        <div className="guide row">
          ...
          <p>Come August 1, we are bringing together 140 developers and ideators from USIU&ndash;Africa and universities across Nairobi together to learn new technologies and build awesome things.</p>
